            ...
            <div
              ...
              >
                <li className="nav-item" role="presentation">
                  <a
                    className={`nav-link-tab  ${activeTab === "super-mart" ? "active" : ""
                      }`}
                    id="super-mart-tab"
                ...
                <li className="nav-item" role="presentation">
                  <a
                    className={`nav-link-tab  ${activeTab === "pharmacy" ? "active" : ""
                      }`}
                    id="pharmacy-tab"
                    data-mdb-toggle="pill"
                    href="#pharmacy"
                ...
                <li className="nav-item" role="presentation">
                  <a
                    className={`nav-link-tab  ${activeTab === "fertilizers-shop" ? "active" : ""
                      }`}
                ...
                <li className="nav-item" role="presentation">
                  <a
                    className={`nav-link-tab ${activeTab === "trading-pos" ? "active" : ""
                      }`}
                    id="trading-pos-tab"
                    data-mdb-toggle="pill"
                    href="#trading-pos"
                ...
                <li className="nav-item" role="presentation">
                  <a
                    className={`nav-link-tab ${activeTab === "mobile-shop-pos" ? "active" : ""
                      }`}
